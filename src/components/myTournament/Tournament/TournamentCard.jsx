  ...
  return (
    ...
    >
      ...
      <CardContent className="space-y-1">
        ...
        <Typography variant="body2">👥 Teams: {tournament.teamLimit}</Typography>
        <Typography variant="body2">🎮 Players: {tournament.playerLimit}</Typography>
        <Typography variant="body2">📞 {tournament.contact}</Typography>
        <Typography variant="body2">🆔 Code: <strong>{tournament.code}</strong></Typography>
      </CardContent>
    </Card>
  );
};
